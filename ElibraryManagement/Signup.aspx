                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                <label>Contact</label>
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Contact"></asp:TextBox>
                               </div>
                            </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <label>Pincode</label>
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Pincode"></asp:TextBox>
                               </div>
                            </div>
                             </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>User Id</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" placeholder="User Id" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Password</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox7" placeholder="Password" runat="server" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button CssClass="btn btn-success btn-lg form-control my-3" ID="Button1" runat="server" Text="Sign Up" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>
