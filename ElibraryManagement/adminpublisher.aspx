                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Published Id"></asp:TextBox>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Published Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
